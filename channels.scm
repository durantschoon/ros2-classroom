;; Both channels are pinned: changing either commit is an explicit dependency
;; upgrade.  Run `guix time-machine -C channels.scm -- describe' to inspect the
;; exact Guix used by this project.
(list (channel
        (name 'guix)
